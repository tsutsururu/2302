...
A0 払うか払わないかで最終地点の処理が異なるのが面倒だったので この初期値に対応する関数を別々に作成した。具体的には f(i) で i以降に払う金額の最小値を出力する、つまり f(i) =　min( f(i+1) + Ai : Ai 払って i+1 に餌を与える場合 , f(i+2) + Ai+1 : Ai払わないつまり Ai+1 を払って、i+1 に餌を与える場合 ) とした。


![image](https://user-images.githubusercontent.com/109026838/216985683-3fc54579-1e3a-40a4-8b41-e4ae1e0b428f.png)
